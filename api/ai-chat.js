          ...
          products: {
            ...
            items: {
              ...
              properties: {
                ...
                sku:            { type: ['string', 'null'], description: 'Stok kodu' },
                unit:           { type: ['string', 'null'], description: 'Adet, Metre vb.' },
                purchase_price: { type: ['number', 'string'], description: 'Fiyat' },
                sale_price:     { type: ['number', 'string'], description: 'Fiyat' },
                base_currency:  { type: ['string', 'null'], description: 'USD, TRY vb.' },
                sale_currency:  { type: ['string', 'null'], description: 'USD, TRY vb.' },
