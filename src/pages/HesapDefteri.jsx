                        ...
                        return (
                          <motion.tr key={h.id}
                            ...
                            <td className="py-2 px-1 text-center whitespace-nowrap">
                              <span className="text-[9px] font-bold px-1.5 py-0.5 rounded" style={{ background: h.currency && h.currency !== 'TRY' ? 'rgba(59,130,246,0.1)' : 'rgba(148,163,184,0.06)', color: h.currency && h.currency !== 'TRY' ? '#3b82f6' : '#64748b' }}>
                                {h.currency || 'TRY'}
                              </span>
                            </td>
      ...
      <div className="flex-shrink-0 px-6 pt-5 pb-3">
        ...
        {!loading && filtered.length > 0 && (
          <button onClick={() => {
            ...
            className="flex items-center justify-center gap-2 py-2 rounded-xl text-xs font-semibold transition-all mt-2"
            style={{ background: 'rgba(59,130,246,0.08)', color: '#3b82f6', border: '1px solid rgba(59,130,246,0.2)' }}>
            <Printer size={12}/> Tümünü Yazdır (Hareketliler)
          </button>
        )}
      </div>
